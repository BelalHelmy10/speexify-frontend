...
// The single public conversion path for an individual starter-session request.
// Keep this pointed at the form that actually submits the request to `/api/contact`.
export function getStarterSessionHref(locale = "en") {
  return routeHref(APP_ROUTES.individualTraining, locale, "#trial");
}
