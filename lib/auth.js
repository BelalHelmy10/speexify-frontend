...
export async function me() {
  return request(() => api.get("/api/auth/me", opts));
}
...
export async function login(payload) {
  return request(() => api.post("/api/auth/login", payload, opts));
}
...
export async function googleLogin(credential) {
  return request(() => api.post("/api/auth/google", { credential }, opts));
}
...
export async function logout() {
  return request(() => api.post("/api/auth/logout", null, opts));
}
...
export async function registerStart(email) {
  return request(() => api.post("/api/auth/register/start", { email }, opts));
}
...
export async function registerComplete(payload) {
  return request(() => api.post("/api/auth/register/complete", payload, opts));
}
