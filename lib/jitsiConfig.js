...
export function getToolbarButtons({ isTeacher }) {
  ...
  //
  // `desktop` is also omitted: screen sharing is driven by our own
  // control-bar button which goes through a confirmation modal,
  // role gating, and a sticky banner. Letting Jitsi's own button
  // start a share bypasses all of that.
  return [
    "microphone",
    "camera",
    "fullscreen",
