...
export const PRICING_REGIONS = {
  ...
  US: {
    currency: "USD",
    multiplier: 5, // 40% of EGP price (adjust this!)
    name: "United States",
  },
  ...
  GB: {
    currency: "GBP",
    multiplier: 5, // 35% of EGP price (adjust this!)
    name: "United Kingdom",
  },
  ...
  AE: {
    currency: "AED",
    multiplier: 9, // 70% of EGP price (adjust this!)
  ...
  DEFAULT: {
    currency: "USD",
    multiplier: 5, // 50% of EGP price (adjust this!)
    name: "International",
  },
};
