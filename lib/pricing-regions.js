...
export const PRICING_REGIONS = {
  ...
  US: {
    currency: "USD",
    multiplier: 0.375, // 40% of EGP price (adjust this!)
    name: "United States",
  },
  ...
  GB: {
    currency: "GBP",
    multiplier: 0.25, // 35% of EGP price (adjust this!)
    name: "United Kingdom",
  },
  ...
  AE: {
    currency: "AED",
    multiplier: 0.25, // 70% of EGP price (adjust this!)
  ...
  DEFAULT: {
    currency: "USD",
    multiplier: 0.25, // 50% of EGP price (adjust this!)
    name: "International",
  },
};
