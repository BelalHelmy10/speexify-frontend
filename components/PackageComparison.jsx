...
const COPY = {
  ...
  ar: {
    eyebrow: "المقارنة الواضحة", title: "اختار الأنسب ليك.",
    ...
    guidance: "دعم البرنامج", reporting: "التقارير", operations: "التشغيل والربط",
    ask: "اسأل عن التفاصيل", view: "شوف الباقة", contact: "ناقش البرنامج",
    note: "كل خانة بتوضح تفاصيل الباقة. لو ظهر «اسأل عن التفاصيل»، يبقى محتاجين نأكدها حسب حالتك.",
