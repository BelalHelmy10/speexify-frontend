...
const KIDS_AR = {
  ...
  coaches: {
    eyebrow: "الكوتشز",
    title: "مدرّبين طفلك هيحترمهم ويحب يتعلم منهم.",
    sub:
